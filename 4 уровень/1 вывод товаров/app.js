...
let tegDiv = document.querySelector('.products');
let tegButton = document.querySelectorAll('button');
tegButton.forEach(function (element){
...
function getProductMarkup(product) {
    for(let i = 0; i < product.length; i++) {
        ...
        tegDiv.insertAdjacentHTML("beforeend", `<div class="product">
